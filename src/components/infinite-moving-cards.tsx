  ...
  return (
    ...
    >
      ...
      >
        {items.map((item) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 bg-slate-100 border-slate-200 px-8 py-6 md:w-[450px] flex flex-col justify-between"
            key={item.name}
          >
            <div
              aria-hidden="true"
